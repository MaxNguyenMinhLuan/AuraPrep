...
interface SecondPlaceIconProps {
    className?: string;
}

const SecondPlaceIcon: React.FC<SecondPlaceIconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} shapeRendering="crispEdges">
        ...
        <text x="10.5" y="13.5" fill="currentColor" fontSize="6.5" fontWeight="black" fontFamily="monospace">2</text>
    </svg>
);
