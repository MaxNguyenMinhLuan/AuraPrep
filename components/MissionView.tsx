    ...
    return (
        <div className="flex flex-col h-auto animate-fadeIn relative">
            ...
            <div className="flex items-center justify-between mb-3 md:mb-4">
                 <button onClick={onExit} className="text-text-dim hover:text-highlight p-2 -ml-2 touch-target font-bold text-xs md:text-sm uppercase tracking-wider">&larr; Back</button>
            </div>
