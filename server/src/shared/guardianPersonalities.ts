  ...
  Light: {
    ...
    evening: [
      ...
      },
      {
        ...
        body: `{{userName}}!\n\nThis is my final candle-flicker. The magic has faded. If you don't do today's mission, the light of our {{currentStreak}}-day streak goes cold forever. Save us.\n\n→ <a href="{{deepLink}}">Protect the Flame</a>\n\nAlmost dark,\n{{guardianName}} 🕯️`
      }
    ]
  },
 ...
 */
export function getNudgeTemplate(creatureType: CreatureType, nudgeLevel: NudgeLevel): NudgeTemplate {
